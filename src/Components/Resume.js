      ...
      <div className="section-vcardbody section-page" id="page-resume">
        ...
        <div className="section-education">
          ...
          <div className="resume-buttons header-page-buttons">  
            {/* Download CV button */}
            <a href="#" className="btn btn-default btn-default2"><i className="fa fa-download" />&nbsp; Ayo Kunjung Project Muhammd</a>
            {/* /Download CV button */}
            {/* Get in Touch button */}
          ...
          <div className="testimonial-slides" id="testimonial-carousel">
            ...
            <div className="testimonial-item">
              ...
              <div className="testimonial-credits">
                ...
                <div className="testimonial-picture">
                  <img src="https://tse2.mm.bing.net/th?id=OIP.YK5UOPS8g45IevqHhBO-rAHaFj&pid=Api&P=0&w=234&h=176" alt />
                </div>							
                {/* /picture */}
            ...
            <div className="testimonial-item">
              ...
              <div className="testimonial-credits">
                {/* picture */}
                <div className="testimonial-picture">
                  <img src="https://tse3.mm.bing.net/th?id=OIP.oa7UebgSBgYsY8yrkhQ4ZgHaEo&pid=Api&P=0&w=287&h=180" alt />
                </div>							
                {/* /picture */}
            ...
            <div className="testimonial-item">
              ...
              <div className="testimonial-credits">
                {/* picture */}
                <div className="testimonial-picture">
                  <img src="https://tse2.mm.bing.net/th?id=OIP.JkF6KkjhvFBvRumEroy9QAHaIZ&pid=Api&P=0&w=300&h=300" alt />
                </div>							
                {/* /picture */}
